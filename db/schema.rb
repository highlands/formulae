...
ActiveRecord::Schema.define(version: 20170425223000) do
  ...
  create_table "choices", force: :cascade do |t|
    ...
    t.datetime "created_at",                            null: false
    t.datetime "updated_at",                            null: false
    t.index ["question_dependency_id"], name: "index_choices_on_question_dependency_id", using: :btree
  ...
  create_table "question_dependencies", force: :cascade do |t|
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["question_id"], name: "index_question_dependencies_on_question_id", using: :btree
  end
  ...
  create_table "question_submissions", force: :cascade do |t|
    ...
    t.datetime "created_at",         null: false
    t.datetime "updated_at",         null: false
    t.index ["form_submission_id"], name: "index_question_submissions_on_form_submission_id", using: :btree
    t.index ["multi_select_id"], name: "index_question_submissions_on_multi_select_id", using: :btree
    t.index ["question_id"], name: "index_question_submissions_on_question_id", using: :btree
  end
